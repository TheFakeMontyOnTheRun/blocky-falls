...
namespace BlockyFalls {
		...
		void CHighScoresScreenRouter::initWithDefaults() {
			auto view = std::make_shared<BlockyFalls::CHighScoresScreenView>(getRenderer());
			auto interactor = std::make_shared<BlockyFalls::CHighScoresScreenInteractor>(shared_from_this());
			auto presenter = std::make_shared<BlockyFalls::CHighScoresScreenPresenter>(view);
